...
export default function AboutPage() {
  return (
    <PageFrame active="about">
      <InnerHero eyebrow="ABOUT LP FLANGE" title="A practical manufacturing partner in Jiangsu" text="Jiangsu Longping Metal Products Co., Ltd. has focused on stainless steel flange production since 2016, serving global distributors and industrial buyers from Dainan Town, Jiangsu, China." image="/images/factory-exterior.png" imageAlt="LP Flange factory exterior in Jiangsu, China" />
